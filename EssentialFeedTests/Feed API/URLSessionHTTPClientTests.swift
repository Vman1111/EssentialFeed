...
//  EssentialFeedTests
//
//  Created by Vytautas Sapranavicius on 23/06/2023.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFrojmURL_succeedsOnHTTPURLResponseWithData() {
        let data = anyData()
    ...
    func test_getFrojmURL_succeedsWithEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
